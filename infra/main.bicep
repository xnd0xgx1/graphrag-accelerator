...
output azure_ai_search_name string = 'srch-qrg6duk4d73z2'
...
output azure_storage_account string = 'stqrg6duk4d73z2'
output azure_storage_account_blob_url string = 'https://stqrg6duk4d73z2.blob.core.windows.net/'
output azure_cosmosdb_endpoint string = 'https://cosmos-qrg6duk4d73z2.documents.azure.com:443/'
output azure_cosmosdb_name string = 'cosmos-qrg6duk4d73z2'
output azure_cosmosdb_id string = ''
output azure_app_insights_connection_string string = ''
output azure_apim_name string = 'apim-qrg6duk4d73z2'
output azure_apim_gateway_url string = 'https://apim-qrg6duk4d73z2.azure-api.net'
output azure_dns_zone_name string = 'graphrag.io'
output azure_app_hostname string = appHostname
output azure_app_url string = appUrl
output azure_workload_identity_client_id string = ''
output azure_workload_identity_principal_id string = ''
output azure_workload_identity_name string = ''
output azure_private_dns_zones array = []
